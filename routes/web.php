...
Route::middleware(['auth', 'role:admin,guest,teacher'])->group(function () {
...
Route::get('/empoloyee', 'EmpoloyeeController@index');

Route::resource('post', 'PostController');
//Route::resource('post', 'PostController');
//Route::resource('p-r-o-f-i-l-e', 'PROFILEController');
