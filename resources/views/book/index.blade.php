                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th class="d-none">Content</th>
                                        <th>Year</th><th>Price</th><th>Isbn</th><th>Author Id</th>
                                        <th>Publisher Id</th><th>Photo</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($book as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td class="d-none">{{ $item->title }}</td><td>{{ $item->content }}</td><td>{{ $item->year }}</td><td>{{ $item->price }}</td><td>{{ $item->isbn }}</td><td>{{ $item->author_id }}</td><td>{{ $item->publisher_id }}</td>
